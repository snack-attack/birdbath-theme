...
!function (e, t) {
  ...
  var f = "3.4.0 -ajax,-ajax/jsonp,-ajax/load,-ajax/parseXML,-ajax/script,-ajax/var/location,-ajax/var/nonce,-ajax/var/rquery,-ajax/xhr,-manipulation/_evalUrl,-event/ajax,-effects,-effects/Tween,-effects/animatedSelector",
      E = function E(e, t) {
  ...
  var h = function (n) {
          ...
          return 1 === g && 0 === v ? function (e) {
            ...
            if (c) {
              ...
              if (u = [m ? c.firstChild : c.lastChild], m && d) {
                p = (s = (r = (i = (o = (a = c)[N] || (a[N] = {}))[a.uniqueID] || (o[a.uniqueID] = {}))[h] || [])[0] === k && r[1]) && r[2], a = s && c.childNodes[s];
              ...
              } else if (d && (p = s = (r = (i = (o = (a = e)[N] || (a[N] = {}))[a.uniqueID] || (o[a.uniqueID] = {}))[h] || [])[0] === k && r[1]), !1 === p) while (a = ++s && a && a[l] || (p = s = 0) || u.pop()) {
                if ((b ? a.nodeName.toLowerCase() === f : 1 === a.nodeType) && ++p && (d && ((i = (o = a[N] || (a[N] = {}))[a.uniqueID] || (o[a.uniqueID] = {}))[h] = [k, p]), a === e)) break;
              }
    ...
    return me.prototype = x.filters = x.pseudos, x.setFilters = new me(), h = se.tokenize = function (e, t) {
      ...
      if (!a) {
        ...
        (a = A(e, (v = o, m = 0 < (y = i).length, b = 0 < v.length, r = function r(e, t, n, _r, i) {
          var o,
              a,
              s,
              u = 0,
  ...
  E.filter = function (e, t, n) {
    ...
    is: function is(e) {
      return !!L(this, "string" == typeof e && A.test(e) ? E(e) : e || [], !1).length;
    }
  });
  var j,
      q = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]+))$/;
    ...
    o ? (G.set(e, i, !1), E.event.add(e, i, {
      ...
      handler: function handler(e) {
        ...
        if (1 & e.isTrigger && this[i]) {
          if (r) (E.event.special[i] || {}).delegateType && e.stopPropagation();else if (r = s.call(arguments), G.set(this, i, r), t = o(this, i), this[i](), r !== (n = G.get(this, i)) || t ? G.set(this, i, !1) : n = void 0, r !== n) return e.stopImmediatePropagation(), e.preventDefault(), n;
        } else r && (G.set(this, i, E.event.trigger(E.extend(r.shift(), E.Event.prototype), r, this)), e.stopImmediatePropagation());
      }
    })) : E.event.add(e, i, Ee);
  }
    ...
    special: {
      ...
      click: {
        setup: function setup(e) {
          var t = this || e;
          return fe.test(t.type) && t.click && S(t, "input") && void 0 === G.get(t, "click") && Se(t, "click", Ee), !1;
        },
        trigger: function trigger(e) {
          var t = this || e;
          return fe.test(t.type) && t.click && S(t, "input") && void 0 === G.get(t, "click") && Se(t, "click"), !0;
        },
